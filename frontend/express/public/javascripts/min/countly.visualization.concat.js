...
})(jQuery, document);;/*! Javascript plotting library for jQuery, v. 0.7.
 *
    ...
    function Plot(placeholder, data_, options_, plugins) {
        ...
        function measureTickLabels(axis) {
            ...
            if (axis.direction == "x") {
                ...
                if (w == null)
                    w = 60//w = Math.floor(canvasWidth / (ticks.length > 0 ? (series[0].data.length) : 1));//onur change ticks.lenght to series[0].data.length
        ...
        function setupGrid() {
            ...
            if (options.grid.show) {
                ...
                if (minMargin == null) {
                    minMargin = 0;
                    for (i = 0; i < series.length; ++i)
                        minMargin = Math.max(minMargin, series[i].points.radius + series[i].points.lineWidth/2) - 0; /*onur add - 5*/
                }
            ...
            for (var j = 0; j < axes.length; ++j) {
                ...
                for (var i = 0; i < axis.ticks.length; ++i) {
                    ...
                    if (axis.direction == "x") {
						...
						/*onur: add - 10*/
                        pos.top = Math.round(plotOffset.top + axis.p2c(tick.v) - axis.labelHeight/2) - 10;
                        if (axis.position == "left") {
                    ...
                    var style = ["z-index:-10", "position:absolute", "text-align:" + align ];
                    for (var a in pos)
